...
Function vrdtvs_Convert_File (	byVal	CF_FILE_AbsolutePathName, _
	...
	WScript.StdOut.WriteLine("VRDTVS vrdtvs_Convert_File - Content of FFMPEG LOG file """ & ff_logfile & """ Below :")
	...
	Set ff_tmp_object = Nothing
	WScript.StdOut.WriteLine("VRDTVS vrdtvs_Convert_File - Content of FFMPEG LOG file """ & ff_logfile & """ Above.")
	'???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
	'???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
