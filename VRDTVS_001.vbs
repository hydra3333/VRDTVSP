...
'
Dim vrdtvs_tmp, vrdtvs_REM, vrdtvs_status, vrdtvs_exit_code, vrdrvs_Err_Code, vrdrvs_Err_Description, vrdtvs_cmd, vrdtvs_exe_obj ' a few working variables, for common use
...
'
vrd_version_for_qsf = vrdtvs_get_commandline_parameter("vrd_version_for_qsf",vrd_version_for_qsf)                                                   ' /vrd_version_for_qsf:5
...
vrd_show_mediainfo = vrdtvs_get_commandline_parameter("show_mediainfo",vrd_show_mediainfo)                      		                    		' /show_mediainfo:False
...
Function vrdtvs_Convert_File (	byVal	CF_FILE_AbsolutePathName, _
	...
	If CF_do_qsf Then
		...
		CF_object_saved_ffmpeg_commands.WriteLine("REM ====================================================================================================================================================================")
		vrdtvs_status = vrdtvs_delete_a_file(CF_QSF_AbsolutePathName, True) ' True=silently delete it
		WScript.StdOut.WriteLine(vrdtvs_current_datetime_string() & " ====================================================================================================================================================================")
		WScript.StdOut.WriteLine(vrdtvs_current_datetime_string() & " ====================================================================================================================================================================")
	...
	If vrdtvs_DEBUG OR vrd_show_mediainfo Then
	...
	vrdtvs_Exec_in_a_DOS_BAT_file_cmd_array(0) = vrdtvs_REM & """" & vrdtvs_mediainfoexe64 & """ --Legacy """ & CF_FILE_AbsolutePathName & """"
	...
	End If
	ReDim vrdtvs_Exec_in_a_DOS_BAT_file_cmd_array(1) ' base 0, so the dimension is always 1 less than the number of commands
	vrdtvs_Exec_in_a_DOS_BAT_file_cmd_array(0) = vrdtvs_REM & """" & vrdtvs_mediainfoexe64 & """ --Legacy """ & CF_QSF_AbsolutePathName & """"
	...
	ElseIf Ucase(T_V_Codec_legacy) = Ucase("AVC") Then
		...
		'vrd_profile_name_for_qsf = vrd_profile_name_for_qsf_avc
	Else
		If vrdtvs_DEBUG Then WScript.StdOut.WriteLine("VRDTVS DEBUG: VRDTVS ERROR vrdtvs_Convert_File - Error - Unrecognised T_V_Codec_legacy video codec """ & CF_TARGET_AbsolutePathName & """ T_V_Codec_legacy=""" & T_V_Codec_legacy & """ ... Ignoring file ...")
		WScript.StdOut.WriteLine("VRDTVS ERROR vrdtvs_Convert_File - Error - Unrecognised T_V_Codec_legacy video codec """ & CF_TARGET_AbsolutePathName & """ T_V_Codec_legacy=""" & T_V_Codec_legacy & """ ... Ignoring file ...")
		If vrdtvs_DEVELOPMENT_NO_ACTIONS Then ' DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV DEV 
			Wscript.Echo "Error 17 = cannot perform the requested operation"
			On Error goto 0
			WScript.Quit 17 ' Error 17 = cannot perform the requested operation
	...
	WScript.StdOut.WriteLine("VRDTVS vrdtvs_Convert_File: output TARGET file: " & " T_V_FrameRate=" & T_V_FrameRate & " (T_V_Frame_Rate_FF=" & T_V_Frame_Rate_FF & ") T_V_Codec_legacy: """ & T_V_Codec_legacy & """ T_V_ScanType: """ & T_V_ScanType & """ T_V_ScanOrder: """ & T_V_ScanOrder & """ " & T_V_Width & "x" & T_V_Height & " dar=" & T_V_DisplayAspectRatio_String_slash & " sar=" & T_V_PixelAspectRatio & " T_A_Codec_legacy: " & T_A_Codec_legacy & " T_A_Audio_Delay_ms: " & T_A_Audio_Delay_ms & " T_A_Audio_Delay_ms_legacy: " & T_A_Audio_Delay_ms_legacy & " T_A_Video_Delay_ms: " &  T_A_Video_Delay_ms & " T_A_Video_Delay_ms_legacy: " &  T_A_Video_Delay_ms_legacy)
	WScript.StdOut.WriteLine("VRDTVS vrdtvs_Convert_File: End FFMPEG of """ & CF_FILE_AbsolutePathName & """ into """ & CF_TARGET_AbsolutePathName & """")
	WScript.StdOut.WriteLine("VRDTVS vrdtvs_Convert_File: " & vrdtvs_current_datetime_string() & " ======================================================================================================================================================")
