...
Function vrdtvsp_create_custom_adscan_script_vrd6()
	...
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "closeflag = VideoReDo.FileClose()"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "Wscript.StdOut.WriteLine(""."" & OutputGetState & "". AdScan 100% Complete."")"
...
Function vrdtvsp_create_custom_QSF_vbscript_vrd6()
	...
	c=c+1 : ReDim Preserve ccqsfs(c) : ccqsfs(c) = "Dim openflag, closeflag, outputOK, OutputGetState"
	...
	c=c+1 : ReDim Preserve ccqsfs(c) : ccqsfs(c) = "Wscript.StdOut.WriteLine(""."" & OutputGetState & "". QSF 100% Complete."")"
