...
Const const_vrd6_adscan_profile_name = "VRDTVSP_ADSCAN_VRD6_NON-INTERACTIVE"	' alternate for interactive is "VRDTVSP_ADSCAN_VRD6"
...
vrdtvsp_Insomnia64_tmp_filename = vrdtvsp_gimme_a_temporary_absolute_filename("VRDTVSP_Insomnia64_copy-" & vrdtvsp_run_datetime) & ".exe"
...
Function vrdtvsp_create_custom_adscan_script_vrd6()
	...
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan: ERROR: arg count should be 3, but is "" & argCount)"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan:			Args(0) is the fully qualified path/name of the input video file"")"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan:			Args(1) is the fully qualified path/name of the output project (.vprj) file."")"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan:			Args(2) is name of AdScan Output Profile already created and saved inside VRD v6"")"
	...
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan: ERROR: no VRD6 AdScan profiles were returned by VRD v6"")"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan: Exiting with errorlevel code 5"")"
	...
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan: ERROR: no VRD6 AdScan profile was located matching your specified profile: """""" & adscan_profile_name & """""""")"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	For i = 0 to profile_count-1"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "		a_profile_name = VideoReDo.ProfilesGetProfileName( i )"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "		is_adscan = VideoReDo.ProfilesGetProfileIsAdScan( i )"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "		If ( is_adscan ) Then"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "			adscan_profile_count = adscan_profile_count + 1"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "			Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan: Profile ("" & i & "")="""""" & a_profile_name & """""" is an adscan profile"")"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "		End If"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Next"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan: Adscan Profile count: "" & adscan_profile_count )"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan: Exiting with errorlevel code 5"")"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	on error resume Next"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	VideoReDo.ProgramExit()"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	on error goto 0"
	...
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan: ERROR: VideoReDo failed to open file: """""" & inputFile & """""""")"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	'on error resume Next"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	on error goto 0"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	VideoReDo.ProgramExit()"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	on error goto 0"
	...
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan: ERROR: VideoReDo failed to create AdScan file: """""" & vprjFile & """""" using profile:"""""" & adscan_profile_name & """""""")"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	'on error resume Next"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	on error goto 0"
	...
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "Wscript.StdOut.Write(""VRDTVSP_VRD6_AdScan: working: "")"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "'Wscript.StdOut.Write(""VRDTVSP_VRD6_AdScan: Percent Complete: "")"
	...
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan AdScan 100% Complete."")"
	
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "Wscript.StdOut.WriteLine(""VRDTVSP_VRD6_AdScan: Exiting"")"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	'on error resume Next"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "	on error goto 0"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "VideoReDo.ProgramExit()"
	c=c+1 : ReDim Preserve ccvas(c) : ccvas(c) = "on error goto 0"
