...
-vf "setdar=16/9" -fps_mode passthrough -sws_flags lanczos+accurate_rnd+full_chroma_int+full_chroma_inp -strict experimental ^
...
-cq:v 0 -b:v 1500000 -minrate:v 100000 -maxrate:v 3000000 -bufsize 3000000 ^
