...
def change_filename_layout(new_basename):
    ...
    new_basename = case_insensitive_replace(new_basename, "-7flix-Adelaide", "")
    new_basename = case_insensitive_replace(new_basename, "_7flix-Adelaide", "")
    new_basename = case_insensitive_replace(new_basename, "-7flix", "")
    new_basename = case_insensitive_replace(new_basename, "_7flix", "")
    ...
    new_basename = case_insensitive_replace(new_basename, "-7mateHD_Adelaide", "")
    new_basename = case_insensitive_replace(new_basename, "_7mateHD_Adelaide", "")
    new_basename = case_insensitive_replace(new_basename, "-7mateHD-Adelaide", "")
    new_basename = case_insensitive_replace(new_basename, "_7mateHD-Adelaide", "")
