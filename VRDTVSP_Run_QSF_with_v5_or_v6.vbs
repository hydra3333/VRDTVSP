...
fileObj.WriteLine("findstr /c:""ECHO is on"" /I "".\tmp_echo_status.log"">NUL 2>&1")
fileObj.WriteLine("if not errorlevel 1 (set ""initial_echo_status=ON"") else (set ""initial_echo_status=OFF"")")
fileObj.WriteLine("DEL /F "".\tmp_echo_status.log"">NUL 2>&1")
fileObj.WriteLine("REM ---")
