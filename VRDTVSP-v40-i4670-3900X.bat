...
echo ### "!prefix!" >> "!vrdlog!" 2>&1
echo set !prefix! >> "!vrdlog!" 2>&1
set !prefix! >> "!vrdlog!" 2>&1
...
echo set All SRC_FF_ >> "!vrdlog!" 2>&1
set All SRC_FF_ >> "!vrdlog!" 2>&1
ECHO !DATE! !TIME! ====================================================================================================================================================== >> "!vrdlog!" 2>&1
...
ECHO !DATE! !TIME! ====================================================================================================================================================== >> "!vrdlog!" 2>&1
ECHO !DATE! !TIME! List All SRC_FF_ variables  >> "!vrdlog!" 2>&1
echo set All SRC_MI_ >> "!vrdlog!" 2>&1
set All SRC_MI_ >> "!vrdlog!" 2>&1
ECHO !DATE! !TIME! ====================================================================================================================================================== >> "!vrdlog!" 2>&1
pause
