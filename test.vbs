...
Function get_ffprobe_video_stream_parameter (ffp_Parameter, ffp_MediaFilename) 
    ...
    ' ffp_cmd = """" & vrdtvs_ffprobeexe & """ -hide_banner -v quiet -select_streams v:0 -show_entries stream=" & ffp_Parameter & " -of default=noprint_wrappers=1:nokey=1 """ & ffp_MediaFilename & """ > """ & ffp_temp_Filename & """"
    '
