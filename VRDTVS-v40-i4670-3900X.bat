...
set "destination_mp4_Folder=G:\TEST-vrdtvsp-v40\VRDTVS-Converted\"
...
ECHO !DATE! !TIME! COMPUTERNAME="!COMPUTERNAME!"  header="!header!" >> "!vrdlog!"
ECHO !DATE! !TIME! root="!root!" >> "!vrdlog!"
ECHO !DATE! !TIME! root_nobackslash="!root_nobackslash!" >> "!vrdlog!"
ECHO !DATE! !TIME! vs_root="!vs_root!" >> "!vrdlog!"
ECHO !DATE! !TIME! vs_root_nobackslash="!vs_root_nobackslash!" >> "!vrdlog!"
ECHO !DATE! !TIME! vs_path_drive="!vs_path_drive!" >> "!vrdlog!"
ECHO !DATE! !TIME! vs_scripts_path="!vs_scripts_path!" >> "!vrdlog!"
ECHO !DATE! !TIME! vs_plugins_path="!vs_plugins_path!" >> "!vrdlog!"
ECHO !DATE! !TIME! vs_coreplugins_path="!vs_coreplugins_path!" >> "!vrdlog!"

ECHO !DATE! !TIME! ffmpegexe64="!ffmpegexe64!" >> "!vrdlog!"
ECHO !DATE! !TIME! ffmpegexe64_OpenCL="!ffmpegexe64_OpenCL!" >> "!vrdlog!"
ECHO !DATE! !TIME! ffprobeexe64="!ffprobeexe64!" >> "!vrdlog!"
ECHO !DATE! !TIME! mediainfoexe64="!mediainfoexe64!" >> "!vrdlog!"
ECHO !DATE! !TIME! dgindexNVexe64="!dgindexNVexe64!" >> "!vrdlog!"
ECHO !DATE! !TIME! vspipeexe64="!vspipeexe64!" >> "!vrdlog!"
ECHO !DATE! !TIME! py_exe="!py_exe!" >> "!vrdlog!"
ECHO !DATE! !TIME! Insomniaexe64="!Insomniaexe64!" >> "!vrdlog!"

ECHO !DATE! !TIME! vrdlog="!vrdlog!" >> "!vrdlog!"
ECHO !DATE! !TIME! capture_TS_folder="!capture_TS_folder!" >> "!vrdlog!"
...
ECHO !DATE! !TIME! PSlog="!PSlog!" >> "!vrdlog!"
...
ECHO !DATE! !TIME! VRDTVS_QSF_VBS_SCRIPT="!VRDTVS_QSF_VBS_SCRIPT!" >> "%vrdlog%" 2>&1
ECHO !DATE! !TIME! Path_to_vrd6="!Path_to_vrd6!" >> "%vrdlog%" 2>&1
ECHO !DATE! !TIME! Path_to_vp_vbs_vrd6="!Path_to_vp_vbs_vrd6!"
ECHO !DATE! !TIME! Path_to_vrd5="!Path_to_vrd5! >> "%vrdlog%" 2>&1
ECHO !DATE! !TIME! Path_to_vp_vbs_vrd5="!Path_to_vp_vbs_vrd5!"
...
ECHO !DATE! !TIME! Path_to_PS1_to_enforcevalidfilenames="!Path_to_PS1_to_enforcevalidfilenames!" >> "%vrdlog%" 2>&1
ECHO !DATE! !TIME! Path_to_PS1_to_retimestamp="!Path_to_PS1_to_retimestamp!" >> "%vrdlog%" 2>&1
ECHO !DATE! !TIME! Path_to_PS1_to_Calculate_Duration="!Path_to_PS1_to_Calculate_Duration!" >> "%vrdlog%" 2>&1
...
DEL "!Path_to_PS1_to_Calculate_Duration!">NUL 2>NUL
ECHO #----- >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO param ^( [Parameter^(Mandatory=$True^)] [string]$start_date_time, [Parameter^(Mandatory=$True^)] [string]$end_date_time, [Parameter^(Mandatory=$True^)] [string]$prefix_id ^) >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO #[console]::BufferWidth = 512 >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO #echo "Calculate Duration" >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO # >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO Function FormatDuration^([TimeSpan]$Duration^) { >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO     $DurHours = [math]::floor^($Duration.TotalHours^) >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO     $DurMins  = [math]::floor^($Duration.Minutes^) >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO     $DurSecs  = $Duration.Seconds >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO     $DurMs    = $Duration.Milliseconds >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO     if ^($DurHours-1^){$PlHours='s'} else {$PlHours=''} >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO     if ^($DurMins -1^){$PlMins='s'}  else {$PlMins=''} >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO     if ^($DurSecs -1^){$PlSecs='s'}  else {$PlSecs=''} >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO     #if ^($DurMs   -1^){$PlMs='s'}    else {$PlMs=''} >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO     #echo "in function, prefix_id={$prefix_id}" >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO     return "{0}_Duration: {1} hour$($PlHours) {2} minute$($PlMins) {3}.{4} second$($PlSecs)" -f $prefix_id,$DurHours,$DurMins,$DurSecs,$DurMs >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO } >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO # START TEST >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO #echo "outside function, prefix_id={$prefix_id}" >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO #FormatDuration^( ^(New-TimeSpan -Hours 25 -Minutes 45 -Seconds 01^) ^) >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO # END TEST >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO $dt_start_date_time=[datetime]::parse($start_date_time) >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO $dt_end_date_time=[datetime]::parse($end_date_time) >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO #echo "start_date_time='$start_date_time'" >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO #echo "dt_start_date_time='$dt_start_date_time'" >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO #echo "end_date_time='$end_date_time'" >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO #echo "dt_end_date_time='$dt_end_date_time" >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO #echo ^(-join^('Duration in seconds: ', ^($dt_end_date_time - $dt_start_date_time^).TotalSeconds^)^) >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO FormatDuration^( ^($dt_end_date_time - $dt_start_date_time^) ^) >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO #----- >> "!Path_to_PS1_to_Calculate_Duration!" 2>&1
ECHO TYPE "!Path_to_PS1_to_Calculate_Duration!" >> "!vrdlog!" 2>&1
TYPE "!Path_to_PS1_to_Calculate_Duration!" >> "!vrdlog!" 2>&1
REM Call like this :-
REM set "start_date_time=!date! !time!"
REM DO SOMETHING TIME CONSUMING ... 
REM set "end_date_time=!date! !time!"
REM powershell -NoLogo -ExecutionPolicy Unrestricted -Sta -NonInteractive -WindowStyle Minimized -File "!Path_to_PS1_to_Calculate_Duration!" -start_date_time "!start_date_time!" -end_date_time "!end_date_time!" -prefix_id "some_id" >> "!vrdlog!" 2>&1
REM --------- setup the .PS1 to calculate elapsed-time durations ---------

REM --------- setup the .PS1 to ensure valid filenames by stripping bad characters ---------
DEL "!Path_to_PS1_to_enforcevalidfilenames!">NUL 2>NUL
ECHO param ^( [Parameter^(Mandatory=$False^)] [string]$Folder="G:\HDTV\000-TO-BE-PROCESSED", [Parameter^(Mandatory=$False^)] [switch]$Recurse = $False ^)  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO [console]::BufferWidth = 512  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO echo 'Rename files to remove special characters: *** Ignore the error: Exception setting "BufferWidth": "The handle is invalid."'  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO # >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO # Powershell script to rename files to remove all special characters. >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO # BEFORE this powershell script is invoked by the calling batch file, ensure the incoming folder has no trailing "\" >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO # OTHERWISE the trailing double-quote ^" becomes 'escaped', thus everything on the commandline after it gets included in that parameter value. >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO # eg  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO # >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO #set the_folder=G^:^\HDTV^\000-TO-BE-PROCESSED >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO #set "rightmost_character=^!the_folder:~-1^!!" >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO #if ^/I "^!rightmost_character^!" == "^\" ^(set "the_folder=^!the_folder:~,-1^!"^) >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO #powershell -NoLogo -ExecutionPolicy Unrestricted -Sta -NonInteractive -WindowStyle Minimized -File "G:^\HDTV^\000-TO-BE-PROCESSED^\something.ps1" -Recurse -Folder "!the_folder!"  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO #  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO # The following is necessary if an incoming foldername string STILL has a trailing ^\ and DOS quoting does not work  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO echo "Rename files to remove special characters: Incoming Folder = '$Folder'"  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO if ^($Folder.Substring^($Folder.Length-2,2^) -eq '^" '^) {$Folder=$Folder -Replace "..$"} # removes the last 2 characters  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO if ^($Folder.Substring^($Folder.Length-2,2^) -eq ' ^"'^) {$Folder=$Folder -Replace "..$"} # removes the last 2 characters  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO if ^($Folder.Substring^($Folder.Length-2,2^) -eq " '"^) {$Folder=$Folder -Replace "..$"} # removes the last 2 characters  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO if ^($Folder.Substring^($Folder.Length-1,1^) -eq "\"^)  {$Folder=$Folder -Replace ".$"}  # removes the last 1 character  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO if ^($Folder.Substring^(0,1^) -eq "'" -And $Folder.Substring^($Folder.Length-1,1^) -eq "'"^) {$Folder=$Folder.Trim^("'"^)} # removes the specified character from both ends of the string  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO echo "Rename files to remove special characters: Fixed Folder = '$Folder'"  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO if ^($Recurse^) {  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	echo "Rename files to remove special characters: RECURSE FOUND for tree '$Folder'"  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	# note we add -Recurse and leave "\*" off of the folder name  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	$FileList = Get-ChildItem -Path "$Folder" -Recurse -File -Include '*.ts','*.mp4','*.mpg','*.bprj','*.mp3','*.aac','*.mp2'  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO } else {  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	# note we add "\*" to the folder name  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	echo "Rename files to remove special characters: NON RECURSE FOUND for only '$Folder'"  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	$FileList = Get-ChildItem -Path "$Folder\*" -File -Include '*.ts','*.mp4','*.mpg','*.bprj','*.mp3','*.aac','*.mp2'  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO }  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO echo "Rename files to remove special characters: START in folder tree '$Folder' to remove special characters in every .ts .mp4 .mpg .bprj .mp3 filename by Matching them with a regex match in Powershell ..."  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO foreach ^($FL_Item in $FileList^) {  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	#$FL_Item.FullName  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	#$FL_Item ^| Select-Object Name,CreationTime,LastWriteTime  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	$old_full_filename=$FL_Item.FullName  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	$old_filename=$FL_Item.Name  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	# regex replace all successive matches by a single . since there is a trailing + in the regex. ^ means NOT the following.  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	$new_filename=$FL_Item.Name -replace '[^^a-zA-Z0-9-_. ]+','.'  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	if^($old_filename -ne $new_filename^){  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 		echo "Renaming: '$old_full_filename' to '$new_filename'"  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 		$FL_Item ^| Rename-Item -NewName {$new_filename}  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	} else {  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 		echo "Left alone: '$old_full_filename'"  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO 	}  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO }  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO echo "Rename files to remove special characters: FINISH  in folder tree '$Folder' to remove special characters in every .ts .mp4 .mpg .bprj .mp3 filename by Matching them with a regex match in Powershell ..."  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO ## regex [^^a-zA-Z0-9-_. ]+  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO ## the leading hat ^^ character means NOT in any of the set, trailing + means any number of matches in the set  >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO ## a-z >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO ## A-Z >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO ## 0-9 >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO ## - underscore . space >> "!Path_to_PS1_to_enforcevalidfilenames!" 2>&1
ECHO !DATE! !TIME! TYPE "!Path_to_PS1_to_enforcevalidfilenames!" >> "!vrdlog!" 2>&1
...
ECHO [console]::BufferWidth = 512  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO echo 'Set file date-time timestamps: *** Ignore the error: Exception setting "BufferWidth": "The handle is invalid."'  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO # >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO # Powershell script to rename files to remove all special characters. >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO # BEFORE this powershell script is invoked by the calling batch file, ensure the incoming folder has no trailing "\" >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO # OTHERWISE the trailing double-quote ^" becomes 'escaped', thus everything on the commandline after it gets included in that parameter value. >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO # eg  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO # >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO #set the_folder=G^:^\HDTV^\000-TO-BE-PROCESSED >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO #set "rightmost_character=^!the_folder:~-1^!!" >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO #if ^/I "^!rightmost_character^!" == "^\" ^(set "the_folder=^!the_folder:~,-1^!"^) >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO #powershell -NoLogo -ExecutionPolicy Unrestricted -Sta -NonInteractive -WindowStyle Minimized -File "G:^\HDTV^\000-TO-BE-PROCESSED^\something.ps1" -Recurse -Folder "!the_folder!"  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO #  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO # The following is necessary if an incoming foldername string STILL has a trailing ^\ and DOS quoting does not work  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO echo "Set file date-time timestamps: Incoming Folder = '$Folder'"  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO if ^($Folder.Substring^($Folder.Length-2,2^) -eq '^" '^) {$Folder=$Folder -Replace "..$"} # removes the last 2 characters  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO if ^($Folder.Substring^($Folder.Length-2,2^) -eq ' ^"'^) {$Folder=$Folder -Replace "..$"} # removes the last 2 characters  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO if ^($Folder.Substring^($Folder.Length-2,2^) -eq " '"^) {$Folder=$Folder -Replace "..$"} # removes the last 2 characters  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO if ^($Folder.Substring^($Folder.Length-1,1^) -eq "\"^)  {$Folder=$Folder -Replace ".$"}  # removes the last 1 character  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO if ^($Folder.Substring^(0,1^) -eq "'" -And $Folder.Substring^($Folder.Length-1,1^) -eq "'"^) {$Folder=$Folder.Trim^("'"^)} # removes the specified character from both ends of the string  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO echo "Set file date-time timestamps: Fixed Folder = '$Folder'"  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO if ^($Recurse^) {  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	echo "Set file date-time timestamps: RECURSE FOUND for tree '$Folder'"  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	# note we add -Recurse and leave "\*" off of the folder name  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	$FileList = Get-ChildItem -Path "$Folder" -Recurse -File -Include '*.ts','*.mp4','*.mpg','*.bprj','*.mp3','*.aac','*.mp2'  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO } else {  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	# note we add "\*" to the folder name  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	echo "Set file date-time timestamps: NON RECURSE FOUND for only '$Folder'"  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	$FileList = Get-ChildItem -Path "$Folder\*" -File -Include '*.ts','*.mp4','*.mpg','*.bprj','*.mp3','*.aac','*.mp2'  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO }  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO echo "Set file date-time timestamps: START in folder tree '$Folder' ..."  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO # >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO # 1. capture a commandline parameter 1 as a mandatory "Folder string" with a default value >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO $DateFormat = "yyyy-MM-dd" >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO # 2. Iterate the files >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO foreach ^($FL_Item in $FileList^) { >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	$fn = $FL_Item.FullName >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	#echo "Processing Timestamp for 'fn'" >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	$ixxx = $FL_Item.BaseName -match '^(^?^<DateString^>\d{4}-\d{2}-\d{2}^)' >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	if^($ixxx^){ >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 		$DateString = $Matches.DateString >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 		$date_from_file = [datetime]::ParseExact^($DateString, $DateFormat, $Null^) >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	} else { >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 		$date_from_file = $FL_Item.CreationTime.Date # .Date removes the time component >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	} >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	$FL_Item.CreationTime = $date_from_file >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	$FL_Item.LastWriteTime = $date_from_file >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	$df=$date_from_file.ToString() # .ToString() formats the date/time >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	$cd=$FL_Item.CreationTime.ToString() # .ToString() formats the date/time >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	$lw=$FL_Item.LastWriteTime.ToString() # .ToString() formats the date/time >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO 	echo "Set '$df' into Creation-date: '$cd' Modification-Date: '$lw' on '$fn'" >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO } >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO echo "Set file date-time timestamps: FINISH in folder tree '$Folder' ..."  >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO # https://stackoverflow.com/questions/56211626/powershell-change-file-date-created-and-date-modified-based-on-filename >> "!Path_to_PS1_to_retimestamp!" 2>&1
ECHO TYPE "!Path_to_PS1_to_retimestamp!" >> "!vrdlog!" 2>&1
TYPE "!Path_to_PS1_to_retimestamp!" >> "!vrdlog!" 2>&1
REM --------- setup the .PS1 to re-timestamp files based on filename dates  ---------
...
for %%f in ("!source_TS_Folder!*.TS", "!source_TS_Folder!*.MPG", "!source_TS_Folder!*.MP4", "!source_TS_Folder!*.VOB") do (
	...
	powershell -NoLogo -ExecutionPolicy Unrestricted -Sta -NonInteractive -WindowStyle Minimized -File "!Path_to_PS1_to_Calculate_Duration!" -start_date_time "!iloop_start_date_time!" -end_date_time "!iloop_end_date_time!" -prefix_id ":::::::::: iloop %%f " >> "!vrdlog!" 2>&1
)
...
ECHO !DATE! !TIME! input TS file: Video Codec: "!V_Codec_legacy!" ScanType: "!V_ScanType!" ScanOrder: "!V_ScanOrder!" !V_Width!x!V_Height! dar=!V_DisplayAspectRatio_String! sar=!V_PixelAspectRatio! Audio Codec: "!A_Codec_legacy!" A_Audio_Delay_ms: !A_Audio_Delay_ms! Audio_Delay_ms_legacy: !A_Video_Delay_ms_legacy!  
...
ECHO cscript //Nologo "!Path_to_vrd_vp_vbs!" "%~f1" "!scratch_file_qsf!" /qsf /p %VRDTVS_qsf_profile% /q /na
ECHO cscript //Nologo "!Path_to_vrd_vp_vbs!" "%~f1" "!scratch_file_qsf!" /qsf /p %VRDTVS_qsf_profile% /q /na >> "%vrdlog%" 2>&1
set "qsf_start_date_time=!date! !time!"
cscript //Nologo "!Path_to_vrd_vp_vbs!" "%~f1"  "!scratch_file_qsf!" /qsf /p %VRDTVS_qsf_profile% /q /na >> "%vrdlog%" 2>&1
set "qsf_end_date_time=!date! !time!"
powershell -NoLogo -ExecutionPolicy Unrestricted -Sta -NonInteractive -WindowStyle Minimized -File "!Path_to_PS1_to_Calculate_Duration!" -start_date_time "!qsf_start_date_time!" -end_date_time "!qsf_end_date_time!" -prefix_id "QSF" >> "!vrdlog!" 2>&1
...
REM ECHO "!mediainfoexe64!" --full "!scratch_file_qsf!" to "%~f1.QSF.mediainfo.txt" 
...
SET loudnorm_TP=0.0
SET loudnorm_LRA=11
ECHO !DATE! !TIME! "!ffmpegexe64!"  -nostats -nostdin -y -hide_banner -i "!scratch_file_qsf!" -threads 0 -vn -af loudnorm=I=%loudnorm_I%:TP=%loudnorm_TP%:LRA=%loudnorm_LRA%:print_format=json -f null -
...
IF /I "!V_ScanType!" == "Progressive" (
	...
	IF /I "!Q_V_Codec_legacy!" == "AVC" (
		...
		ECHO "***FF*** "
		ECHO "***FF*** " >> "%vrdlog%" 2>&1
		ECHO "***FF*** Progressive AVC input - setting ff_cmd accordingly ... copy video stream, convert audio stream
		...
		ECHO "***FF*** "
		ECHO "***FF*** " >> "%vrdlog%" 2>&1
		ECHO "***FF*** Progressive MPEG2 input - setting ff_cmd accordingly ... denoise/sharpen video stream via vapoursynth, convert audio stream "
		...
		set "end_date_time=!date! !time!"
		powershell -NoLogo -ExecutionPolicy Unrestricted -Sta -NonInteractive -WindowStyle Minimized -File "!Path_to_PS1_to_Calculate_Duration!" -start_date_time "!start_date_time!" -end_date_time "!end_date_time!" -prefix_id "VSdgindexNVexe64" >> "!vrdlog!" 2>&1		
	...
	IF /I "!Q_V_Codec_legacy!" == "AVC" (
		...
		ECHO "***FF*** "
		ECHO "***FF*** " >> "%vrdlog%" 2>&1
		ECHO "***FF*** Interlaced AVC input - setting ff_cmd accordingly ... denoise/sharpen video stream via vapoursynth, convert audio stream "
		...
		IF /I "!Footy_found!" == "TRUE" ( 
			...
			ECHO "***FF*** "
			ECHO "***FF*** " >> "%vrdlog%" 2>&1
			ECHO "***FF*** Interlaced FOOTY AVC input detected - resetting ff_cmd accordingly ... denoise/sharpen video stream via vapoursynth, with HQ settings, convert audio stream "
		...
		ECHO "***FF*** "
		ECHO "***FF*** " >> "%vrdlog%" 2>&1
		ECHO "***FF*** Interlaced MPEG2 input - setting ff_cmd accordingly ... denoise/more-sharpen video stream via vapoursynth, convert audio stream "
...
powershell -NoLogo -ExecutionPolicy Unrestricted -Sta -NonInteractive -WindowStyle Minimized -File "!Path_to_PS1_to_Calculate_Duration!" -start_date_time "!ff_start_date_time!" -end_date_time "!ff_end_date_time!" -prefix_id ":::::::::: ff" >> "!vrdlog!" 2>&1
ECHO !DATE! !TIME! +++++++++++++++++++++++++
ECHO !DATE! !TIME! +++++++++++++++++++++++++ >> "%vrdlog%" 2>&1
ECHO !DATE! !TIME! +++++++++++++++++++++++++
ECHO !DATE! !TIME! +++++++++++++++++++++++++ >> "%vrdlog%" 2>&1
...
ECHO !DATE! !TIME!
ECHO cscript //Nologo "!Path_to_vrd_vp_vbs!" "!scratch_file_qsf!" "!destination_file!" /p %VRDTVS_conversion_profile% /q /na
ECHO cscript //Nologo "!Path_to_vrd_vp_vbs!" "!scratch_file_qsf!" "!destination_file!" /p %VRDTVS_conversion_profile% /q /na >> "%vrdlog%" 2>&1
REM cscript //Nologo "!Path_to_vrd_vp_vbs!" "!scratch_file_qsf!"  "!destination_file!" /p %VRDTVS_conversion_profile% /q /na >> "%vrdlog%" 2>&1
...
REM ECHO "!mediainfoexe64!" --Full "!destination_file!" to "%~f1.CONVERTED.mediainfo.txt" 
REM ECHO "!mediainfoexe64!" --Full "!destination_file!" to "%~f1.CONVERTED.mediainfo.txt" >> "!vrdlog!" 2>&1
REM "!mediainfoexe64!" --Full "!destination_file!" > "%~f1.CONVERTED.mediainfo.txt" 
...
ECHO cscript //Nologo "!Path_to_adscan_vbs!" "!destination_file!" "!adscan_destination_file!" /q
...
set "VRDTVS_QSF_VBS_SCRIPT=!root!vrdtvs_qsf_script.vbs"
REM
...
REM return a datetime string with spaces replaced by zeroes
...
:get_header_string
REM Create a Header
set "header_variable_name=%~1"
call :get_date_time_string "date_time_string"
