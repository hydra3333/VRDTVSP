...
Function vrdtvsp_exec_a_command_and_show_stdout_stderr (byVAL eac_command_string)
	...
	Do While eac_exe_object.Status = 0 '0 is running and 1 is ending
		Wscript.Echo "vrdtvsp_exec_a_command_and_show_stdout_stderr About to sleep for ' & sleep_amount & ' ms"
...
Function vrdtvsp_Convert_File (	byVal	CF_FILE_AbsolutePathName, _
	...
	vrdtvsp_Exec_in_a_DOS_BAT_file_cmd_array(3) = Replace(vrdtvsp_Exec_in_a_DOS_BAT_file_cmd_array(3), "%", "%%", 1, -1, vbTextCompare) ' just for the mediainfo command run from WITHIN in a .BAT file
	CF_object_saved_ffmpeg_commands.WriteLine("REM")
	for iii=0 to 3
